...
public class FrameOutput extends javax.swing.JFrame {
    ...
    public void addOutput(String value,boolean newLine) {
        String oldText=this.textareaOutput.getText();
        if (newLine) {
            this.textareaOutput.setText(oldText + "\n" + value);
        } else {
            this.textareaOutput.setText(oldText + value);
        }
    }
    public String getOutput() {
        return this.textareaOutput.getText();
    }
    ...
    private void init() {
        ...
        this.textareaOutput.setFont(font);
        this.textareaOutput.setFont(font);
    }
